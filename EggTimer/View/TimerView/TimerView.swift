...
final class TimerView: BaseView {
    ...
    private let elapsedTimeLable: UILabel = {
        let lable = UILabel()
        lable.text = Resources.Title.elapsedTime
    ...
    private let remainingTimeLable: UILabel = {
        let lable = UILabel()
        lable.text = Resources.Title.remainigTime
    ...
    func configure(with duration: Double, progress: Double) {
        ...
        completedPercentView.configure(with: Resources.Title.completed, andValue: roundedPercent)
        remainingPercentView.configure(with: Resources.Title.remaining, andValue: 100 - roundedPercent)
